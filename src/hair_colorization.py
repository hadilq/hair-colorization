...
class HairColorization:
    ...
    def train(self, image_dir, output_dir, data_dir, num_train_samples, batch_size, model_path=model_path, **kwargs):
        ...
        steps_per_epoch = np.uint8(np.floor(num_train_samples * dataset.sample_expansion_rate / batch_size))
    ...
    def predict(self, img, b_mask, gray_img, hue, output_dir):
        ...
        if img is None:
            ...
            return None
        processed_img, processed_mask, _, window = preprocess_image(
...
class HairColorizationPyDataset(PyDataset):
    ...
    def __len__(self):
        ...
        return math.ceil(self.num_train_samples * self.sample_expansion_rate / self.batch_size)
    ...
    def __getitem__(self, idx):
        ...
        while len(processed_img_list) < self.batch_size and data_idx < len(self.data_list):
            ...
            processed_img, processed_mask, true_img, _ = preprocess_image(
...
def preprocess_image(img_h, img_w, img, gray_img, b_mask, output_dir):
    ...
    return processed_img, processed_mask, expected_img, window
